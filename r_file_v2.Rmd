...
```{r, echo=TRUE}
col_to_remove = c("Street", "Utilities", "RoofMatl", "Condition2","Exterior1st", "Exterior2nd", "Electrical")
for (name in col_to_remove){cat(which(colnames(home)==name)," ")}
home_streamlined = home[-c(6 ,9 ,22, 14, 23, 24, 41)]
```


```{r, echo=TRUE}
home_streamlined[c(186, 251, 667, 1322),1:ncol(home_streamlined)]
```
