...
lasso_regression <- predict(lasso_best, s = best_lam, newx = x_vars[x_test,])
```

```{r}
# Displaying our regression model
...
plot(lasso_regression, which=3) # P2
acf(residuals(lasso_regression), main= "Auto-correlation plot") # P3
plot(lasso_regression, which=2) # P4
plot(lasso_regression, which=5) # Cook
```
