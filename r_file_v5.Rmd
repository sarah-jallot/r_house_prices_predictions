...
>>>>>>> b624eaf9842e969e212e82179fa7d2fc86823434
```{r, include = FALSE}
load("DataProject.RData")
...
The list of features is extensive: not all regressors will be useful to predict house price.  
...
Scaling our data could optimise model performance.  
=======
...
- We also removed some features based on Anova tests: OverallCond, Exterior1st, Exterior2nd.  
- For some features, we were not sure wether or not they had an influence, so we tested the model with and without them and removed them if they were not improving our score : HeatingQC, SaleCondition, BsmtFinType2, RoofStyle, ExterQual. 
=======
- For some features, we were not sure wether or not they had an influence, so we tested the model with and without them and removed them if they were not improving our score : HeatingQC, SaleCondition, BsmtFinType2, RoofStyle, ExterQual. 
>>>>>>> b624eaf9842e969e212e82179fa7d2fc86823434
