...
(this is also the case for RoofMatl, Heating, XXXX)  
...
(this is also the case for Exterior1st, Exterior2nd, GarageCond, XXXX)
...
(this is also the case for XXXX)
...
mean(home$SalePrice)
```
As we guessed, it appears that houses from the XX areas are less expensive than XXX. Let us confirm this visual impression with a proper test.
