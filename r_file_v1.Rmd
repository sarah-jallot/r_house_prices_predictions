...
```
From this summary, R appears to classify our regressors in the right category. All quantitative features are integers and price, the output, is the only numeric.  
...
plt.show()
```
Histograms are a good way to understand the behavior of each regressor. # COMMENT
