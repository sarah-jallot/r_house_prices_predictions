...
```{r}
table(home$HouseStyle)[order(table(home$HouseStyle))]
```
...
```{r}
levels(home$Neighborhood) <- c(levels(home$Neighborhood), "Under20Sales") 
home$Neighborhood[home$Neighborhood %in% c("Blueste","NPkVill","Veenker","BrDale","Blmngtn","MeadowV")] = "Under20Sales"  #"StoneBr","SWISU","ClearCr","IDOTRR","Timber","NoRidge")

table_neighborhood2= table(home$Neighborhood)
table_neighborhood2[order(table_neighborhood2)]
```
